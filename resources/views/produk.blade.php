        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto" style="margin-right: 70px">
                ...
                <li class="nav-item" style="margin-right: 20px">
                  <a class="nav-link navbar3" style="color: white; font-weight: 600; text-align: center;" href="/produk">Produk</a>
                </li>
                <li class="nav-item" style="margin-right: 20px">
          ...
          <div class="container mt-5">
            <h3 style="text-align: center; color:rgb(67, 109, 247); margin-left: 20px">PRODUK KAMI</h3>
            <div class="row  mt-5 justify-content-left" style="width: 1200px">
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            ...
                            <img class="mt-5" style="width: 250px; margin-left: 10px;" src="assets/logo_hydro.png" alt="">
                   
                            <div class="justify-content-lg-start mt-3" style="margin-left: 1rem">
                              <p style="font-size: 25px"><b>HYDRO</b></p>
                              <p>HYDRO adalah Business to Business (B to B) marketplace yang mempertemukan antara pemilik produk dengan para online marketer yang siap membantu memasarkan produk para produsen secara online.</p>
                              
                            </div>
                            <div class="col-7 justify-content-lg-start mt-3" style="margin-left: 1rem">
                              <a href="https://hydroweb.id/" class="btn btn-primary" style=" width: 100px; border-radius: 20px;" target="_blank">DETAIL</a>
                            </div>
                        </div><hr>
                            ...
                            <img class="mt-5" style="width: 250px; margin-left: 10px;" src="assets/logo_atom.png" alt="">
                   
                            <div class="justify-content-lg-start mt-3" style="margin-left: 1rem">
                              <p style="font-size: 25px"><b>ATOM</b></p>
                              <p>ATOM adalah sebuah system yang dapat membantu Anda untuk mengembangkan aplikasi mobile profile dan toko online berbasis Android/IOS dengan sangat mudah dan cepat tanpa Anda harus memahami akan kode pemrograman.</p>
                              
                            </div>
                            <div class="col-7 justify-content-lg-start mt-3" style="margin-left: 1rem">
                              <a href="https://atommobile.net/" class="btn btn-primary" style=" width: 100px; border-radius: 20px;" target="_blank">DETAIL</a>
                            </div>
                        </div><hr>
                            ...
                            <img class="mt-5" style="width: 250px; margin-left: 10px;" src="assets/logo_molecule.png" alt="">
                   
                            <div class="justify-content-lg-start mt-3" style="margin-left: 1rem">
                              <p style="font-size: 25px"><b>MOLECULE</b></p>
                              <p>Molecule adalah sebuah layanan yang berfokus menyediakan layanan social media management, sangat cocok bagi Anda yang memiliki keterbatasan waktu dan kemampuan untuk membuat konten social media seperti feed Instagram.</p>
                              
                            </div>
                            <div class="col-7 justify-content-lg-start mt-3" style="margin-left: 1rem">
                              <a href="/molecule" class="btn btn-primary" style=" width: 100px; border-radius: 20px;">DETAIL</a>
                            </div>
                        </div><br>
