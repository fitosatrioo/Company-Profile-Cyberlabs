        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto" style="margin-right: 70px">
                ...
                <li class="nav-item" style="margin-right: 20px">
                  <a class="nav-link navbar4" style="color: white; font-weight: 600; text-align: center;" href="/layanan">Layanan</a>
                </li>
                <li class="nav-item" style="margin-right: 20px">
          ...
          <h3 class="mt-5" style="text-align: center; color:rgb(67, 109, 247); margin-left: 20px">LAYANAN KAMI</h3>
            ...
            <div class="row  mt-5 justify-content-left" style="width: 1200px"> --}}
                {{-- <div  style="background-color: #e4eaee; padding:70px;"> --}}
                    <div class="container mt-4 mb-5">
                      ...
                      <div class="row">
                       <div class="col-2">
                         <img style="width: 250px; margin-left: 50px; margin-top: 60px" src="assets/service_CMS.png" alt="">
                       </div>
         
                       <div class="col-7 justify-content-lg-start mt-3" style="margin-left: 12rem">
                        <p style="font-size: 20px"><b>C.M.S (CyberLabs Marketing Services)</b></p>
                         <h8><b>C.M.S</b> atau kepanjangan dari <b> CyberLabs Marketing Service </b> adalah layanan konsultan digital 
                             marketing bagi Anda yang belum optimal dalam penggunaan internet untuk menunjang bisnis Anda. Dengan layanan ini maka Anda dapat 
                             mengetahui pemanfaatan dan strategi digital marketing seperti website, SEO, Google Ads, Social Media Marketing, Email Marketing dan 
                             lainnya agar bisnis Anda dapat tumbuh dengan lebih optimal.</h8>
                      ...
                      <div class="row">
                       <div class="col-2">
                         <img style="width: 250px; margin-left: 50px; margin-top: 60px" src="assets/service_CAS.png" alt="">
                       </div>
         
                       <div class="col-7 justify-content-lg-start mt-3" style="margin-left: 12rem">
                        <p style="font-size: 20px"><b>C.A.S (CyberLabs Application Services)</b></p>
                         <h8><b>CyberLabs Application Service ( C.A.S )</b> adalah layanan yang disediakan oleh CyberLabs untuk membantu 
                             yang memiliki kebutuhan khusus akan pembuatan Website, Aplikasi Android & IOS secara custom atau sesuai keinginan
                              ...
                              solusi yang tepat untuk Anda.</h8>
