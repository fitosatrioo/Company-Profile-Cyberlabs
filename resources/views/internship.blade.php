...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
          ...
          <h3 class="mt-5" style="text-align: center; color:rgb(67, 109, 247); margin-left: 20px">INTERNSHIP PROGRAM</h3>
            ...
            <div class="row  mt-5 justify-content-left" style="width: 1200px"> --}}
                {{-- <div  style="background-color: #e4eaee; padding:70px;"> --}}
                    <div class="container mt-4 mb-5">
                      ...
                      <div class="row">
                       <div class="col-2">
                         <img style="width: 200px; margin-left: 50px; margin-top: 40px; border-radius: 95px" src="uploads/internship/{{ $item->image }}" alt="">
                       </div>
         
                       <div class="col-7 justify-content-lg-start mt-3" style="margin-left: 12rem">
                        <p class="mt-4" style="font-size: 20px"><b>{{ $item->title }}</b></p>
                         <p style="font-size: 14.5px">{!! $item->content !!} </p>
          ...
          <div class="container text-md-start pt-5">
            <div class="row" id="puter">
              ...
              <div class="justify-content-lg-start" style="margin-left: 20rem">
