...
<head>
    ...
    <style>
      .navbar2{
        width: 90px;
        height: 39px;
        background-color: rgb(247, 185, 84);
        border-radius: 70px;
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto" style="margin-right: 70px">
                ...
                <li class="nav-item" style="margin-right: 20px">
                  <a class="nav-link " style="color: rgb(0, 0, 0); font-weight: 600;" href="/tentang">Tentang</a>
                </li>
                <li class="nav-item" style="margin-right: 20px">
                ...
                <li class="nav-item" style="margin-right: 20px">
                  <a class="nav-link navbar2" style="color: rgb(255, 255, 255); font-weight: 600; text-align: center;" href="/order">Order</a>
                </li>
                <li class="nav-item" style="margin-right: 20px">
          ...
          <div class="container mt-5">
            <h3 style="text-align: center; color:rgb(67, 109, 247); margin-left: 20px">FORM ORDER APLIKASI</h3>
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <form action="/order" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group" style="width: 1100px; margin-left: 30px; margin-top: 20px">
                                  <label  for="formGroupExampleInput">Nama</label>
                                  <input style="margin-top: 5px" type="text" name="nama" class="form-control" id="formGroupExampleInput" placeholder="Masukkan Nama">
                                </div>
                                <div class="form-group" style="width: 1100px; margin-left: 30px; margin-top: 20px">
                                  <label for="formGroupExampleInput2">Email</label>
                                  <input style="margin-top: 5px" type="text" name="email" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan Email">
                                </div>
                                <div class="form-group" style="width: 1100px; margin-left: 30px; margin-top: 20px">
                                  <label for="formGroupExampleInput2">Telepon</label>
                                  <input style="margin-top: 5px" type="number" name="telepon" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan No Telepon">
                                </div>
                                <div class="form-group" style="width: 1100px; margin-left: 30px; margin-top: 20px">
                                  <label name="produk" style="margin-top: 5px" for="formGroupExampleInput2">Produk</label>
                                  <select class="form-control" name="produk" "  style="width:1100px;">
                                 ...
                                 <div class="form-group" style="width: 1100px; margin-left: 2px; margin-top: 20px">
                                    <label for="formGroupExampleInput2">Deadline</label>
                                    <input name="deadline" style="margin-top: 5px" type="date" class="form-control" id="formGroupExampleInput2">
                                  </div>
                                </div>
                                <div class="form-group" style="width: 1100px; margin-left: 2px; margin-top: 20px;">
                                    <label style="margin-left: 30px" for="formGroupExampleInput2">pesan</label>
                                    <textarea name="pesan" class="form-control"  placeholder="Pesan" style="width: 1100px; margin-left: 30px; margin-bottom: 20px"  cols="30" rows="13" required></textarea>
                                    <button style="width: 1100px; margin-left: 30px; margin-bottom: 20px; color:white" name="kirim" type="submit" class="btn btn-info">SUBMIT</button>
                                  </div>
