...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
          ...
          <h3 class="mt-5" style="text-align: center; color:rgb(67, 109, 247); margin-left: 20px">BERITA & INFO</h3>
          ...
          @foreach ($datas as $item)
                    <div class="container mt-4 mb-5">
                      ...
                      <div class="row">
                       <div class="col-2">
                         <img style="width: 250px; margin-left: 50px; margin-top: 20px" src="uploads/news/{{ $item->image }}" alt="">
                       </div>
         
                       <div class="col-7 justify-content-lg-start mt-3" style="margin-left: 12rem">
                        <p style="font-size: 20px; margin-top: 50px; color:blue">{{ $item->title }}</p>
                         <h8>{!! $item->content !!}</h8>
