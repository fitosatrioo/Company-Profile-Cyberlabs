          ...
          {{-- <div class="container mt-5">
            ...
            <div class="row  mt-5 justify-content-left" style="width: 1200px"> --}}
                {{-- <div  style="background-color: #e4eaee; padding:70px;"> --}}
                    <div class="container">
                        <h3 class="mt-5" style="text-align: center; color:rgb(67, 109, 247);">Company Visit</h3>
                        <div class="row mt-5 justify-content-left" style="width: 1200px">
                      
                            @foreach ($datas as $item)
                         <div class="col-md-3">
                        <img style="margin-left: 15px; width: 220px" src="uploads/company/{{ $item->image }}" alt="">
                        <div class="mt-4">
                            <h5 >{{ $item->title }}</h5><br>
                            <h8 style="color: grey">{!! $item->content !!} </h8>
