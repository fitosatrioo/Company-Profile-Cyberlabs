...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto" style="margin-right: 70px">
                ...
                <li class="nav-item" style="margin-right: 20px">
                  <a class="nav-link navbar2" style="color: white; font-weight: 600; text-align: center;" href="/tentang">Tentang</a>
                </li>
                <li class="nav-item" style="margin-right: 20px">
          ...
          <div class="container mt-5">
            <h3 style="text-align: center; color:rgb(67, 109, 247); margin-left: 20px">TENTANG KAMI</h3>
            <div class="row  mt-5 justify-content-left" style="width: 1200px">
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                          ...
                          <div class="img-area text-center mt-2"><img src="img/cyberlabs.png" alt=""></div>
                          <div class="img-text" style="margin-top: 30px">
                            <h1 class="" style="font-size: 15px; margin-left: 7px; margin-top: 15px">{!! $item->content !!}</h1>
                          @endforeach
